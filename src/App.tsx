                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedTerm.related_terms.map(t => (
                      <span key={t} className="bg-indigo-50 text-indigo-600 px-3 py-1 rounded-full text-xs font-medium">
                        {t}
                      </span>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedTerm.confusion_terms.map(t => (
                      <span key={t} className="bg-rose-50 text-rose-600 px-3 py-1 rounded-full text-xs font-medium">
                        {t}
                      </span>
                    ))}
                  </div>
